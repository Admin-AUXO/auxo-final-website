...
export const aboutContent: AboutContent = {
  ...
  "mission": {
    ...
    "missionText": "Our mission is to close the \"Intelligence Gap\" by delivering decision-grade intelligence with unmatched velocity and precision.",
    "title": "Mission & Vision",
    "visionHighlight": [
      "effortless",
      "clear, confident, and precise"
    ],
    "visionText": "To make intelligence effortless — a world where every decision is clear, confident, and precise"
  },
  "partnership": {
  ...
  "purpose": {
    ...
    "descriptionHighlight": [
      "see what their data is truly saying",
