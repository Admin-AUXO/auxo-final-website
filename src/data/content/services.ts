    ...
    industries: [
      {
        ...
        description: "Transform property portfolios with predictive analytics, market intelligence, and investment optimization. Make faster, smarter decisions on acquisitions, development, and asset management.",
        useCases: [
      ...
      },
      {
        ...
        icon: "mdi:store",
        description: "Elevate customer engagement with predictive analytics, inventory intelligence, and trend forecasting. Create seamless experiences that drive loyalty and growth.",
        useCases: [
      ...
      },
      {
        ...
        icon: "mdi:bank",
        description: "Enhance risk management, optimize portfolios, and deepen client relationships through sophisticated analytics. Navigate complexity with confidence.",
        useCases: [
      ...
      },
      {
        ...
        icon: "mdi:truck",
        description: "Streamline operations, reduce costs, and enhance supply chain visibility with real-time analytics. Turn logistics data into competitive advantage.",
        useCases: [
