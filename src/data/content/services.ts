...
export const servicesContent: ServicesContent = {
  "cta": {
    ...
    "title": "Turn Your Analytics Roadmap Into Reality"
  },
  "engagementModels": {
  ...
  "hero": {
    "ctaHref": "#models",
    "ctaText": "Discover Your Model",
    "description": "We meet you at any stage of the analytics maturity curve. We blend strategy consulting, data engineering, and applied data science into flexible Analytics as a Service models—delivering clear decisions, measurable results, and accelerated value.",
    "descriptionHighlight": [
      "flexible Analytics as a Service models",
      "accelerated value"
    ],
    "headlineLine1": "Analytics as a Service,",
    "headlineLine2": "built for impact."
  },
  "impact": {
    "description": "We specialize in data‑rich, decision‑intensive environments where clarity and speed drive competitive advantage. Our analytics solutions are purpose-built for industries that demand precision, agility, and measurable outcomes.",
    "descriptionHighlight": [
    ...
    "industries": [
      {
        ...
        "icon": "mdi:domain",
        "keyBenefit": "Increase portfolio ROI by 15-25% through data-driven investment strategies",
        "keyBenefitHighlight": [
          "15-25%"
        ],
      ...
      },
      {
        ...
        "icon": "mdi:palm-tree",
        "keyBenefit": "Boost RevPAR by 10-20% with predictive pricing and demand optimization",
        "keyBenefitHighlight": [
          "10-20%"
        ],
      ...
      },
      {
        ...
        "icon": "mdi:shopping",
        "keyBenefit": "Improve customer retention by 30%+ through personalized engagement strategies",
        "keyBenefitHighlight": [
          "30%+"
        ],
      ...
      },
      {
        ...
        "icon": "mdi:finance",
        "keyBenefit": "Reduce risk exposure by 20-30% while improving portfolio performance",
        "keyBenefitHighlight": [
          "20-30%"
        ],
      ...
      },
      {
        ...
        "keyBenefit": "Cut operational costs by 15-25% through optimized logistics and forecasting",
        "keyBenefitHighlight": [
          "15-25%"
        ],
  ...
  "serviceOfferings": {
    "codeEdge": "Our methodology ensures consistent quality and a common language across strategy, engineering, analytics, growth, and governance—no matter which stage you start at.",
    "description": "Eight offerings aligned to the analytics maturity curve.",
    "services": [
      {
        "description": "Assess and prepare your data infrastructure for analytics. We evaluate your current data landscape, identify gaps, and create a readiness roadmap.",
        "link": "/services/foundation-readiness",
        "name": "Foundation Readiness",
        "shortDescription": "Assess and prepare your data infrastructure"
      },
      {
        "description": "Modernize your reporting capabilities. We help you move from siloed reports to unified, self-serve BI that gives decision-makers instant access to trusted metrics.",
        "link": "/services/reporting-reset",
        "name": "Reporting Reset",
        "shortDescription": "Modernize your reporting capabilities"
      },
      {
        "description": "Identify and optimize performance bottlenecks. We dig into operational data to uncover where costs are hidden, processes are inefficient, or quality is slipping – then recommend and implement targeted optimizations.",
        "link": "/services/performance-diagnostics",
        "name": "Performance Diagnostics",
        "shortDescription": "Identify and optimize performance bottlenecks"
      },
      {
        "description": "Build predictive models for better planning. We develop demand forecasting, financial projections, and scenario modeling that improve planning accuracy and enable proactive decision-making.",
        "link": "/services/forecasting-lab",
        "name": "Forecasting Lab",
        "shortDescription": "Build predictive models for better planning"
      },
      {
        "description": "Create structured frameworks for key decisions. We design repeatable, data-driven decision processes for areas like pricing optimization, resource allocation, and customer targeting – so decisions are consistent and evidence-based.",
        "link": "/services/decision-playbooks",
        "name": "Decision Playbooks",
        "shortDescription": "Create structured frameworks for key decisions"
      },
      {
        "description": "Automate repetitive analytics workflows. We identify manual, time-consuming processes (reporting, alerts, routine analyses) and automate them, freeing your team to focus on strategic work.",
        "link": "/services/smart-automation",
        "name": "Smart Automation",
        "shortDescription": "Automate repetitive analytics workflows"
      },
      {
        "description": "Leverage AI to enhance analytical capability. We build advanced machine learning solutions, deploy AI-powered recommendation engines, and create intelligent systems that operate at scale – from fraud detection to next-best-action recommendations.",
        "link": "/services/augmented-intelligence-studio",
        "name": "Augmented Intelligence Studio",
        "shortDescription": "Leverage AI to enhance analytical capabilities"
      },
      {
        "description": "Prepare your team for self-service analytics. We assess organizational readiness, provide training, establish governance, and ensure your team can independently use, interpret, and act on analytics – moving you toward true analytics autonomy.",
        "link": "/services/autonomy-readiness-review",
  ...
  "details": [
    {
      "benefits": {
        "description": "Expand analytical capabilities with AI-powered tools and automation.",
        "descriptionHighlight": [
          "Expand analytical capabilities"
        ],
        "features": [
          {
            "description": "AI algorithms that identify complex patterns and relationships in data.",
          ...
          {
            "description": "AI-powered analysis of text, documents, and unstructured data.",
        ...
        "title": "Augmented Intelligence Benefits"
      },
      "cta": {
        "ctaHref": "/contact",
        "ctaText": "Launch AI Studio",
        "description": "Implement AI-powered tools that expand your analytical capabilities and improve decision-making.",
        "descriptionHighlight": [
          "expand your analytical capabilities"
        ],
        "title": "Enhance Analytics with AI"
      },
      "hero": {
        "description": "Apply AI to enhance analytical capabilities across your organization. We implement AI-powered tools for pattern recognition, predictive analytics, and automated insights, augmenting your team's analytical capacity.",
        "descriptionHighlight": [
          "AI-powered tools"
        ],
        "keyBenefits": [
      ...
      "name": "Augmented Intelligence Studio",
      "outcomes": {
        "description": "Enhanced analytical capabilities and improved business outcomes through AI.",
        "descriptionHighlight": [
          "Enhanced analytical capabilities"
        ],
        "metrics": [
          {
            "description": "Increase in analytical processing speed",
            "label": "Analysis Speed",
            "value": "10x"
          },
          {
            "description": "Improvement in identifying hidden patterns",
            "label": "Pattern Discovery",
            "value": "85%"
          },
          {
            "description": "Accuracy of AI-powered predictions",
            "label": "Prediction Accuracy",
            "value": "90%"
          },
          {
            "description": "Increase in actionable insights generated",
      ...
      "overview": {
        "challenges": [
          "Data volumes exceeding human analysis capacity",
          "Difficulty identifying complex patterns and relationships",
          "Time-intensive manual analysis of unstructured data",
          "Limited ability to predict future outcomes and trends"
        ],
        "description": "AI extends what analysts can accomplish by automating routine analysis, identifying patterns humans might miss, and processing larger datasets faster. Our Augmented Intelligence Studio implements AI tools that work alongside your team.",
        "descriptionHighlight": [
          "work alongside"
        ],
        "solutions": [
          ...
          "Intelligent automation of analytical workflows"
        ],
        "title": "AI-Enhanced Analytics"
      },
      "process": {
        "description": "A 14-week program to implement AI-powered analytical capabilities.",
        "descriptionHighlight": [
          "14-week program"
        ],
        "steps": [
          {
            ...
            "description": "Evaluate data quality, infrastructure, and analytical needs.",
            "step": 1,
          ...
          },
          {
            ...
            "description": "Identify high-impact applications for AI and machine learning.",
            "step": 2,
          ...
          },
          {
            ...
            "description": "Prepare and curate data for AI model training and deployment.",
            "step": 3,
          ...
          },
          {
            ...
            "description": "Build and train AI/ML models for specific analytical tasks.",
            "step": 4,
          ...
          },
          {
            ...
            "description": "Integrate AI models into existing analytical workflows.",
            "step": 5,
          ...
          },
          {
            ...
            "description": "Train users and establish AI governance and best practices.",
            "step": 6,
        ...
        "title": "Augmented Intelligence Process"
      },
      "shortDescription": "Leverage AI to enhance analytical capabilities",
    ...
    },
    {
      ...
      "overview": {
        ...
        "descriptionHighlight": [
          "right governance, tools, and training"
        ],
        "solutions": [
...
export function getServiceDetailBySlug(slug: string) {
  if (!slug) return null;
  return servicesContent.details.find((service) => service.slug === slug) || null;
}
